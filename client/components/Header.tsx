...
export default function Header() {
    const { isConnected, stats } = useChannelStore();

    const statsConfig = [
        {
            id: "subs",
            count: isConnected ? "13,74,300" : "0",
            label: "Subscribers",
        ...
        {
            id: "views",
            count: isConnected ? "19,52,13,962" : "0",
            label: "YouTube Views",
