  ...
  const initialNotifications = [
    {
      ...
      desc: "Receive a summary of your channel's growth every Monday.",
      enabled: true,
    },
    {
      id: "realtime",
      title: "Real-time Stats Alerts",
      desc: "Get notified when a video crosses a milestone or goes viral.",
      enabled: false,
    },
    {
      id: "safety",
      title: "Compliance & Safety",
      desc: "Immediate alerts for copyright claims or community guideline shifts.",
      enabled: true,
    },
    {
      id: "updates",
    ...
    <div className="max-w-6xl mx-auto pb-20">
      <div className="mb-10">
        ...
        <p className="text-gray-400">
          Manage your profile, connected channels, and application preferences.
        </p>
      </div>
            ...
            >
              ...
              {activeTab === "connections" && (
                <div className="bg-[#141b25] border border-gray-800 rounded-2xl p-8 space-y-8">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1">
                        Manage your connected channels and API permissions.
                      </p>
                    </div>
                  ...
                  <div className="bg-[#0f1218] border border-gray-800 rounded-3xl p-8 relative overflow-hidden group">
                    {/* Background Glow Effect */}
                    <div
                      className={cn(
                        "absolute -right-10 -top-10 w-40 h-40 rounded-full blur-[80px] transition-all duration-500",
                        isConnected ? "bg-red-600/10" : "bg-gray-800/10",
                      )}
                    />
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                      <div className="flex items-center gap-6">
                        <div
                          className={cn(
                            "w-20 h-20 rounded-3xl flex items-center justify-center shadow-2xl flex-shrink-0 transition-all duration-500",
                            isConnected
                              ? "bg-red-600 shadow-red-600/30 scale-105"
                              : "bg-[#1a1f26] grayscale shadow-none",
                          )}
                        >
                        ...
                        <div>
                          <div className="flex items-center gap-3 mb-2">
                            <p className="text-xs font-black text-white uppercase tracking-[0.2em] opacity-50">
                              {isConnected
                                ? "Primary Channel"
                                : "No Connection"}
                            </p>
                            {isConnected && (
                              <span className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-green-500/10 border border-green-500/20 text-[10px] font-black text-green-500 uppercase tracking-widest">
                          ...
                          <p className="text-sm text-gray-500 mt-1 flex items-center gap-2">
                            {isConnected ? (
                              <>
                                ...
                                Account associated with naaz@example.com
                              </>
                            ) : (
                              "Connect your YouTube account to start tracking performance."
                            )}
                          </p>
                        </div>
                      </div>
                        ...
                        {isConnected ? (
                          <>
                            <button
                              ...
                              className="flex items-center gap-2 px-6 py-3 bg-white/5 hover:bg-white/10 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl border border-white/10 transition-all active:scale-95"
                            >
                              <RefreshCw className="w-3.5 h-3.5" /> Sync Data
                            </button>
                            <button
                              onClick={() => setIsConnected(false)}
                              className="px-6 py-3 bg-red-600/10 text-red-500 text-[10px] font-black uppercase tracking-widest rounded-2xl border border-red-500/30 hover:bg-red-500 hover:text-white transition-all active:scale-95"
                            >
                              Disconnect
                            </button>
                          </>
                  ...
                  <div className="p-6 border border-amber-500/20 bg-amber-500/5 rounded-2xl flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-1 leading-relaxed">
                        You are currently using 85% of your daily API quota for
                        analytics fetching. If you reach 100%, data updates will
                ...
                <div className="bg-[#141b25] border border-gray-800 rounded-2xl p-8">
                  ...
                  <div className="space-y-6">
                    {notifications.map((item) => (
                      <div
                        key={item.id}
                        className="flex items-center justify-between pb-6 border-b border-gray-800/50 last:border-0 last:pb-0"
                      >
                  ...
                  const plans = [
                    {
                      ...
                      features: ["3 Channels", "7-day history", "Basic AI"],
                      current: false,
                    },
                    {
                      name: "Pro Creator",
                      price: "$29",
                      desc: "Everything for professionals.",
                      features: [
                        "12 Channels",
                        "Unlimited history",
                        "Advanced AI",
                    ...
                    <div className="space-y-8 pb-10">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                          ...
                          <div
                            key={i}
                            className="bg-[#141b25] border border-gray-800 rounded-2xl p-6 relative overflow-hidden group"
                          >
                        ...
                        {plans.map((plan, i) => (
                          <div
                            ...
                            className={cn(
                              ...
                              plan.current
                                ? "border-blue-600 shadow-2xl shadow-blue-600/10 ring-1 ring-blue-600/50"
                          ...
                          >
                            ...
                            <button
                              className={cn(
                                ...
                                plan.current
                                  ? "bg-white/5 text-blue-500 cursor-default"
                      ...
                      {plans.some((p) => p.current) ? (
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                          <div className="bg-[#141b25] border border-gray-800 rounded-3xl p-8">
                            <div className="flex items-center justify-between mb-8">
                              ...
                              <button className="text-[10px] font-black text-blue-500 hover:text-blue-400 uppercase tracking-widest">
                                Add New
                              </button>
                            </div>
                            ...
                            <div className="mt-6 flex items-center gap-3 p-4 bg-white/5 rounded-2xl text-[10px] text-gray-500 leading-relaxed uppercase tracking-tighter">
                              ...
                              processed by Stripe. We never store your card
                              details.
                            </div>
                          </div>
                          ...
                          <div className="bg-[#141b25] border border-gray-800 rounded-3xl p-8">
                            ...
                            <div className="space-y-4">
                              {[
                                ...
                                <div
                                  key={i}
                                  className="flex items-center justify-between p-4 bg-[#0f1218]/50 hover:bg-[#0f1218] rounded-xl border border-transparent hover:border-gray-800 transition-all cursor-default group"
                                >
                                  <div>
                        ...
                        <div className="bg-[#141b25] border border-gray-800 border-dashed rounded-3xl p-12 text-center">
                          ...
                          <p className="text-sm text-gray-500 max-w-sm mx-auto mb-8">
                            Select a plan from above to unlock premium features
                          ...
                          <div className="flex items-center justify-center gap-2 text-[10px] text-gray-600 uppercase tracking-widest font-black">
                            <Shield className="w-4 h-4" /> Secure Payment via
                            Stripe
                          </div>
                        </div>
                      )}
